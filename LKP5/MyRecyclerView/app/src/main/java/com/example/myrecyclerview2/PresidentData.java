...
public class PresidentData {
    ...
    public static ArrayList<President> getListData(){
        com.example.myrecyclerview2.President president = null;
        ArrayList<com.example.myrecyclerview2.President> list = new ArrayList<>();
        for (String[] aData : data){
            president = new com.example.myrecyclerview2.President();
